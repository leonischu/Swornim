...
const professionals = [
  {
    ...
    price: "NPR 25,000",
    experience: "8 years",
    image: "/images/professionals/priya-sharma.jpg",
    portfolio: [
  ...
  },
  {
    ...
    price: "NPR 15,000",
    experience: "6 years",
    image: "/images/professionals/sita-maharjan.jpg",
    portfolio: ["/images/portfolio/makeup-1.jpg", "/images/portfolio/makeup-2.jpg", "/images/portfolio/makeup-3.jpg"],
  ...
  },
  {
    ...
    price: "NPR 20,000",
    experience: "5 years",
    image: "/images/professionals/rajesh-thapa.jpg",
    portfolio: ["/images/portfolio/dj-1.jpg", "/images/portfolio/dj-2.jpg", "/images/portfolio/dj-3.jpg"],
  ...
  },
  {
    ...
    price: "NPR 30,000",
    experience: "7 years",
    image: "/images/professionals/maya-gurung.jpg",
    portfolio: [
      "/images/portfolio/decoration-1.jpg",
      "/images/portfolio/decoration-2.jpg",
      "/images/portfolio/decoration-3.jpg",
    ],
  ...
  },
  {
    ...
    experience: "10 years",
    image: "/images/professionals/bikash-shrestha.jpg",
    portfolio: [
  ...
  },
  {
    ...
    price: "NPR 40,000",
    experience: "9 years",
    image: "/images/professionals/anita-rai.jpg",
    portfolio: [
...
const ImageWithFallback = ({
  ...
  alt,
  className,
  fallbackSrc = "https://via.placeholder.com/300x300/667eea/ffffff?text=No+Image",
}) => {
                      ...
                      <div className="portfolio-images">
                        {professional.portfolio.slice(0, 3).map((image, index) => (
                          <ImageWithFallback
                            ...
                            fallbackSrc={`https://via.placeholder.com/80x80/667eea/ffffff?text=Work+${index + 1}`}
                          />
                        ))}
                      </div>
                    </div>
